...
glslc -c -fshader-stage=fragment quad_pma.frag -o quad_pma_frag.spv
...
glslc -c -fshader-stage=fragment apply_colormap.frag -o apply_colormap_frag.spv
glslc -c -fshader-stage=fragment apply_colormap_a.frag -o apply_colormap_a_frag.spv
glslc -c -fshader-stage=fragment ps_overlay.frag -o ps_overlay_frag.spv
python3 -c "
import struct, os
files = ['quad_vert','quad_frag','quad_pma_frag','gray_frag','blur_frag','gamma_frag','adjust_gamma_frag','univ_trans_frag','present_frag','crossfade_frag','fill_frag','apply_colormap_frag','apply_colormap_a_frag','ps_overlay_frag']
for f in files:
